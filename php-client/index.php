...
<body>
  <main class="app-shell">
    <section class="hero-panel">
      <span class="hero-kicker">Demo Comercial Lista para Cliente</span>
      <h1 class="hero-title">Explorador Inteligente de Eventos</h1>
      <p class="hero-subtitle">Interfaz rediseñada con enfoque visual SaaS para presentar listados, filtros y detalle de eventos con una experiencia moderna y profesional.</p>
